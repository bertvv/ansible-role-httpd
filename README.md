...
A simple Ansible role for installing and configuring the Apache web server for RHEL/CentOS 7-8 and Fedora 28+. Specifically, the responsibilities of this role are to:
